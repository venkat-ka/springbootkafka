package com.springkafka.EmailNotificationService.handler;
...
import com.springkafka.EmailNotificationService.error.NotRetrayableException;
import com.springkafka.EmailNotificationService.error.RetryableException;
import com.springkafka.EmailNotificationService.io.ProcessedEventRepository;
import com.springkafka.EmailNotificationService.io.ProcessesedEventEntity;
...
public class ProductCreatedEventHandler {
	...
	public ProductCreatedEventHandler(RestTemplate restTemplate, ProcessedEventRepository processEventRepository) {
	...
	public void handle(@Payload ProductCreatedEvent productCreatedEvent, @Header("messageId") String messageId,
		...
		try {
			...
			processEventRepository.save(new ProcessesedEventEntity(messageId, productCreatedEvent.getProductId()));	
